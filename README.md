...
Como melhorar no futuro/ o que faltou.

- Faltou fazer testes unitários.
- Faltou criar detalhes da partida e partidas ao vivo.

## O que melhorar

- Adicionar React Query para evitar requests via useEffect.
